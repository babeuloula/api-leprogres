<?php
    ...
    class Request {
         ...
         *
         * @return array Données parsées correctement
         * @throws Exception
         */
        public static function execute(String $url, String $type) : array {
            ...
            } else if($res->getStatusCode() != 200 || (!$body->success && $body->returnCode !== 0)) {
                // Oui ne cherchez pas pourquoi, le code de retour de l'API n'est pas 200 mais 0 si la requête est bonne
                throw new Exception("Erreur lors de la récupération des contenus dans l'API : " . $body->message, $res->getStatusCode());
            }
